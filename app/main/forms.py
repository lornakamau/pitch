...
class PitchForm(FlaskForm):
    ...
    category = SelectField("What category are you submitting to?", choices=[("Twitter", "Twitter Pitches"), ( "Elevator", "Elevator"), ("Competitor", "Competitor"), ("Investor", "Investor")],validators=[Required()])
